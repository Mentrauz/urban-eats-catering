    ...
    <div className="pt-24">
      ...
      <section className="py-12 bg-amber-50">
        <div className="container mx-auto px-4">
          ...
          >
            <a href="tel:+91990011223" className="flex items-center gap-3 bg-white px-6 py-3 rounded-full shadow-lg hover:shadow-xl transition-shadow">
              <FaPhone className="text-amber-600" />
              <span className="font-semibold">+91 98765 43210</span>
            </a>
            <a href="https://wa.me/91990011223" className="flex items-center gap-3 bg-white px-6 py-3 rounded-full shadow-lg hover:shadow-xl transition-shadow">
      ...
      <section className="py-16 bg-amber-50">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <motion.a
              href="https://wa.me/91990011223?text=Hi,%20I%20would%20like%20to%20book%20a%20tasting%20session"
              target="_blank"
